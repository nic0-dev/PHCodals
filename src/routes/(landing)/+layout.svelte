...
<header>
	<div class="mx-auto flex h-16 max-w-screen-xl items-center gap-8 px-4 py-2 sm:px-6 lg:px-8 font-semibold tracking-tight leading-5 whitespace-nowrap ">
		<a class="block text-neutral-900" href="/(landing)">
	...
	<div class="flex flex-1 items-center justify-end md:justify-between">
		<nav aria-label="Global" class="hidden md:block">
			<ul class="text-neutral-400 flex items-center gap-6 text-sm">
				<li>
					<a class:text-black={$page.route.id === "/(landing)"} class="shrink-0 px-3 py-3 hover:text-neutral-900" href="/(landing)"> Home </a>
				</li>
				<li>
	...
	<div class="flex items-center gap-4">
		<div class="text-sm flex gap-4 justify-between py-1">
			<a class="hidden md:block" href="/(landing)">
			...
			<button on:click={toggleMenu} data-collapse-toggle="burger-menu" type="button" class="block rounded bg-gray-100 p-2.5 text-neutral-900 transition hover:bg-neutral-200 md:hidden">
...
{#if !visible}
	<div class="w-full md:block md:w-auto bg-gray-50">
		<ul class="text-sm text-neutral-900 mx-6 flex flex-col font-semibold md:flex-row md:mt-0">
			<li>
				<a href="/(landing)" class="{$page.route.id === '/' ? 'block rounded-lg text-center py-2 px-3 md:p-0 bg-primary-500 text-white' : 'block rounded-lg text-center py-2 px-3 md:p-0 hover:text-neutral-900 hover:bg-primary-100'}"> Home </a>
			</li>
			<li>
				<a href="/about" class="{$page.route.id === '/about' ? 'block rounded-lg text-center py-2 px-3 md:p-0 bg-primary-500 text-white' : 'block rounded-lg text-center py-2 px-3 md:p-0 hover:text-neutral-900 hover:bg-primary-100'}"> About </a>
			</li>
			<li>
				<a href="/pricing" class="{$page.route.id === '/pricing' ? 'block rounded-lg text-center py-2 px-3 md:p-0 bg-primary-500 text-white' : 'block rounded-lg text-center py-2 px-3 md:p-0 hover:text-neutral-900 hover:bg-primary-100'}"> Pricing </a>
			</li>
			<li>
				<a href="mailto:mlcagas@up.edu.ph" class="block rounded-lg text-center py-2 px-3 md:p-0 hover:bg-primary-100 hover:text-primary-500">Get in touch</a>
			</li>
			<li>
				<a href="/(landing)" class="my-4 flex flex-row justify-center items-center gap-2 shrink-0 rounded-xl px-3 py-3 bg-gray-200 hover:bg-gray-300">Login</a>
			</li>
		</ul>
	</div>
{/if}
...
<footer>
	<div class="mx-auto max-w-6xl px-4 py-12 sm:px-6 lg:px-8">
		...
		<ul class="mt-12 flex flex-wrap justify-center gap-6 md:gap-8 lg:gap-12">
			...
			<li><a class="text-neutral-900 transition hover:text-gray-700/75" href="/(landing)"> Privacy </a></li>
			<li><a class="text-neutral-900 transition hover:text-gray-700/75" href="/(landing)"> Licensing </a></li>
			<li><a class="text-neutral-900 transition hover:text-gray-700/75" href="/(landing)"> Terms </a></li>
		</ul>

		<ul class="mt-12 flex justify-center gap-6 md:gap-8">
			<li><a href="/(landing)" rel="noreferrer" target="_blank" class="text-neutral-900 transition hover:text-gray-700/75">
			...
			<li><a href="/(landing)" rel="noreferrer" target="_blank" class="text-neutral-900 transition hover:text-gray-700/75">
				<span class="sr-only">GitHub</span><svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
				<path fill-rule="evenodd"
			...
			<li><a href="/(landing)" rel="noreferrer" target="_blank" class="text-gray-900 transition hover:text-gray-700/75">
				<span class="sr-only">Dribbble</span><svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
				<path fill-rule="evenodd"
	...
	<div class="mx-auto max-w-6xl px-4 border-t border-gray-200 pb-8">
		<div class="text-center mt-4 sm:flex sm:justify-between sm:text-left">
			...
			<p class="text-xs flex gap-3 justify-between text-gray-500">
				<a href="/(landing)" class="inline-block text-gray-500 transition hover:opacity-75"> Terms & Conditions </a>
				<a href="/(landing)" class="inline-block text-gray-500 transition hover:opacity-75"> Privacy Policy </a>
				<a href="/(landing)" class="inline-block text-gray-500 transition hover:opacity-75"> Cookies </a>
			</p>
		</div>
	</div>
</footer>