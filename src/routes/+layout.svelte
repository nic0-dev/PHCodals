...
<div class="flex gap-5 justify-between items-center mx-auto px-4 py-2 sm:px-6 sm:py-2 lg:px-16 font-semibold tracking-tight leading-5 whitespace-nowrap max-md:flex-wrap max-md:px-5">	
	...
	<div class="text-sm flex gap-3 justify-between py-1">
		...
		<a href="/"><div class="px-4 py-3 text-white rounded-xl bg-neutral-900 hover:bg-transparent hover:ring-1 hover:ring-black hover:text-neutral-900">Get Started</div></a>
	</div>
</div>
	...
	<div class="mx-auto max-w-6xl px-4 py-12 sm:px-6 lg:px-8">
		...
		<ul class="mt-12 flex flex-wrap justify-center gap-6 md:gap-8 lg:gap-12">
	  	...
	  	<ul class="mt-12 flex justify-center gap-6 md:gap-8">
			...
			<li><a href="/" rel="noreferrer" target="_blank" class="text-gray-700 transition hover:text-gray-700/75">
